      ...
      <div className="mt-20">
        <Container>
          <Flex className={"justify-evenly"}>
            <div className="">
              <FiShoppingCart className="h-8 w-8 ml-28" />
              <h6 className="font-HeaderText font-medium text-2xl text-HeadrColor">
                FAST AND FREE DELIVERY
              </h6>
              <p className="font-HeaderText font-normal text-sm text-HeadrColor">
                Free delivery for all orders over $140
              </p>
            </div>
            <div className="">
              <FaHeadphones className="h-8 w-8 ml-28" />
              <h6 className="font-HeaderText font-medium text-2xl text-HeadrColor">
